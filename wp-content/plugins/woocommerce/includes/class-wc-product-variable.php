...
class WC_Product_Variable extends WC_Product {
	...
	*/
	...
	public function add_to_cart_text() {
		return apply_filters( 'woocommerce_product_add_to_cart_text', $this->is_purchasable() ? 'Chọn' : 'Xem chi tiết', $this );
	}
	...
	public function add_to_cart_description() {
		...
		return apply_filters( 'woocommerce_product_add_to_cart_description', sprintf( __( 'Chọn &ldquo;%s&rdquo;', 'woocommerce' ), $this->get_name() ), $this );
	}
