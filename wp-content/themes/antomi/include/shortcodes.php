  		...
  		<div class="header-search">
  			<div class="search-without-dropdown <?php echo esc_attr($atts["style"]) ?>">
		  		<div class="categories-container">
		  			<div class="cate-toggler-wrapper"><div class="cate-toggler"><span class="cate-text"><?php esc_html_e('All Categories', 'antomi');?></span></div></div>
					...
					$html.='<div class="post-info">';
						...
						$html.='<div class="post-meta">';
							$html.='<p class="post-author">';
								$html.= sprintf( wp_kses(__( '%s', 'antomi' ), array('a'=>array('href'=>array()))), esc_html__('By', 'antomi').' <a href="'.$author_url.'">'.$author_name.'</a>' );
							$html.='</p>';
