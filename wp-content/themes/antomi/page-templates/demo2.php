...
if(count($jscomposer_templates) > 0) {
	foreach($jscomposer_templates as $jscomposer_template){
		if($jscomposer_template->post_title == 'Header1' || $jscomposer_template->post_title == 'Footer1'){
...
<body <?php body_class('home'); ?>>
	...
	<div class="wrapper">
		<div class="page-wrapper">
			<div class="header-container header1 rs-active has-mobile-layout">  
			 	<div class="header">
					<div class="header-content">
						...
						if ( isset($antomi_opt['header_layout']) && $antomi_opt['header_layout']!="") {
							...
							if(count($jscomposer_templates) > 0) {
								foreach($jscomposer_templates as $jscomposer_template){
									if($jscomposer_template->post_title == 'Header1'){ ?>
							...
							if ( isset($antomi_opt['sticky_header']) && $antomi_opt['sticky_header']) {
								if(count($jscomposer_templates) > 0) {
									foreach($jscomposer_templates as $jscomposer_template){
										if($jscomposer_template->post_title == 'HeaderSticky'){ ?>
