...
<div class="images<?php if($is_IE): ?> ie<?php endif ?> <?php echo esc_attr($imageclass); ?>">
	...
	if ( has_post_thumbnail() ) {
		...
		echo apply_filters( 'woocommerce_single_product_image_html', sprintf( '<a href="%s" itemprop="image" class="yith_magnifier_zoom woocommerce-main-image"><img src="%s" alt=" ' . esc_attr__( 'Placeholder', 'antomi' ) . ' " /></a>', $placeholder, $placeholder ), $post->ID );
	}
	?>
</div>
